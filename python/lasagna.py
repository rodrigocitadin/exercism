...
def preparation_time_in_minutes(layers: int) -> int:
    ...
    :return: int - time to preparate in minutes

    Function that takes the number of lasagna layers as an argument
    and returns how many minutes the lasagna still needs to be prepared
...
def elapsed_time_in_minutes(layers: int, elapsed_bake_time: int) -> int:
    ...
    :param layers: int - number of layers
    :param elapsed_time_in_minutes: int - minutes the lasagna has been baking in the oven
    :return: int - total numbers of minutes of cooking

    Function return the total number of minutes you've been cooking,
